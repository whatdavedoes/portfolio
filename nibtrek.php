...
$details = 'I created NibTrek to act as a digital agency identity that I can operate under and grow. Building this website let me implement $_GET and $_POST outside of my learning path and studies. I also had the chance to practice CSS animations, and gain familiarity using Bootstrap\'s classes to quickly change spacing(margin &amp; padding) of HTML elements.';
...
$description = "<span class=\"mr-1 badge badge-pill badge-secondary\">wireframes</span><br>I designed this website around getting potential web design/development clients to submit project request forms. From there, I could follow up with a free proposal, contract, invoices based on milestones, deliverables, receipt, and testimonial follow up. To maintain interest and collect qualifying leads, I used a simple layout keeping the important points and call to action above the fold on the home page. Informative content with call to actions are throughout the website."; 

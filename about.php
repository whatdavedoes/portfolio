...
<!-- Delete or adapt the code below -->
...
<div class="row border-bottom">
    ...
    <!--<div class="col-md-6">
        ...
        <p class="txtWidth cntrBlock mt-4">Whether you are looking for a freelancer for a specific feature/design, a web guy to cover your bases, or just want to network, I am available for a zero expectation chat.
         <br><img class="webcamIcoBtn mb-3" src="img/webcam_ico-min.png">
            Calendly link widget begin 
            <link href="https://assets.calendly.com/assets/external/widget.css" rel="stylesheet">
            <script src="https://assets.calendly.com/assets/external/widget.js" type="text/javascript"></script>
            <a class="btn btn-orange my-3" href="" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/davepierce/30min?primary_color=ffc681'});return false;"> Schedule a Video Call</a>
...
<!--
<div class="row mt-4 mb-4 pt-4 border-bottom">
    <div class="col-md-6 pb-4">
        <img class="cntrBlock cardImg shadow" src="img/old_export-min.jpg">
        <p class="txtWidth cntrBlock mt-3 cntrTxt">Growing up I had many ideas. Armed with Adobe Illustrator and website building software, I created websites/logos for myself and others. I attended the Young Enterprenuers Academy(YEA!) when I was a senior in high school and it fueled the fire. After graduating high school, I got my associates in Music Recording Technology then joined a band playing lead guitar.</p>
    </div>
    <div class="col-md-6 pb-4">
        <img class="cntrBlock cardImg shadow" src="img/new_export-min.jpg">
        <p class="txtWidth cntrBlock mt-3 cntrTxt">Since then, I've been working odd jobs while studying my passions of web development and programming. I enjoy being creative when it comes to design and problem solving. I value simplicity, automation, and contributing to the well being of people. I believe that technology used with good intention is the key to progress.</p>
    </div>
</div>
-->
    
<!-- Delete or adapt the code above -->   

<?php include('inc/contactbox.php'); ?>

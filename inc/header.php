...
<html lang="en">
  <head>
    ...
    <meta name="twitter:title" content="Dave Pierce | Web Design and Development Portfolio">
    <meta name="twitter:description" content="From a young age, Dave was fascinated with computers. After studying music recording technology and moving into web design, Dave found his passion for programming. He values helping others and building connections. When he is not designing or coding the web, he enjoys playing guitar, exercising, and drinking good coffee.">

    <meta name="twitter:image" content="https://www.whatdavedoes.com/img/opengraph-min.jpg">

    <!-- Open Graph data -->
    <meta property="og:title" content="Dave Pierce | Web Design and Development Portfolio" />
    ...
    <meta property="og:description" content="From a young age, Dave was fascinated with computers. After studying music recording technology and moving into web design, Dave found his passion for programming. He values helping others and building connections. When he is not designing or coding the web, he enjoys playing guitar, exercising, and drinking good coffee." />
    ...
    <title>Dave Pierce | Web Developer</title>
  </head>
